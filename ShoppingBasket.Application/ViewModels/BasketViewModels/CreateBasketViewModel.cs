...
public record CreateBasketOutput(string Id, string CustomerId, ICollection<CreateBasketItemOutput> BasketItems, decimal TotalPrice, bool IsPaid, bool IsDeleted);
public record UpdateBasketOutput(string Id, string CustomerId, ICollection<CreateBasketItemOutput> BasketItems, decimal TotalPrice, bool IsPaid, bool IsDeleted);