...
public class CommandHandler
{
    ...
    protected CommandHandler(ILogger logger, IUnitOfWork uow, IMediatorHandler bus, INotificationHandler<DomainNotification> notification)
    {
        _uow = uow;
        _bus = bus;
    ...
    protected static DomainError NotifyValidationErrors(Command message)
    {
        ...
        {
            errors.AddError(new DomainNotification(error.ErrorCode, error.ErrorMessage, ErrorTypes.BadRequest));
        }
